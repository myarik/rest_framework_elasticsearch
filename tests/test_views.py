...
class TestElasticAPIView:
    ...
    def test_get_es_client(self, es_client):
        view = ElasticAPIView()
        view.es_client = es_client
        assert view.get_es_client() == es_client

    def test_get_es_search_without_es_model(self, es_client):
        view = ElasticAPIView()
    ...
    def test_do_search(self, es_client):
        view = self.create_view(es_client)
        view.request = rf.get('/test/')
